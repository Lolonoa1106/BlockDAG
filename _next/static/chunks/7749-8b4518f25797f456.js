            ...
            if (
              (l.dynamicBullets &&
                ...
                l.dynamicMainBullets > 1 &&
                  void 0 !== s &&
                  ((c += e - (s || 0)) > l.dynamicMainBullets - 1
                    ? (c = l.dynamicMainBullets - 1)
                    : c < 0 && (c = 0)),
                (p =
                  ((o =
                    (n = Math.max(e - c, 0)) +
          ...
          if (
            ...
            if (a.navigation && a.navigation.prevEl && a.navigation.nextEl) {
              ...
              (0, r.m)(a.navigation.nextEl).includes(i) &&
                ...
                a.isEnd ? p(t.lastSlideMessage) : p(t.nextSlideMessage)),
                e.includes(i) &&
                  ((a.isBeginning && !a.params.loop) || a.slidePrev(),
                  a.isBeginning
                    ? p(t.firstSlideMessage)
                    : p(t.prevSlideMessage));
            }
            a.pagination &&
        ...
        let E = (e, t, i) => {
          ...
          L = () => {
            ...
            !(function (e, t) {
              ...
              P();
            let { nextEl: o, prevEl: c } = a.navigation ? a.navigation : {};
            (o = (0, r.m)(o)),
              (c = (0, r.m)(c)),
              o && o.forEach((t) => E(t, l, e.nextSlideMessage)),
              c && c.forEach((t) => E(t, l, e.prevSlideMessage)),
              y() &&
          ...
          (function (e) {
            ...
            setTranslate: () => {
              ...
              for (let e = 0, t = s.length; e < t; e += 1) {
                ...
                let E = `translate3d(${S}px,${b}px,${v}px)  rotateX(${h(
                  g
                )}deg) rotateY(${h(m)}deg) scale(${y})`;
                if (
                  (((function (e, t) {
                    let i = (0, r.g)(t);
                    return (
        ...
        q = (0, l.forwardRef)(function (e, t) {
          ...
          return (
            ...
            j(() => {
              ...
              })(P, S.current, R, y.current, (e) => e.key);
              return (
                (S.current = P),
                (y.current = R),
                e.length &&
